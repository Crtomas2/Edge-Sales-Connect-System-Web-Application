...
class PromodisersComponent extends Component
{
    ...
    public $promodiser_id, $Firstname, $Lastname, $Mobilenumber,$Location_code,$promodiser_status,$promodiser_edit_id, $promodiser_delete_id;
    ...
    $view_promodiser_promodiser_status;
    public $searchTerm; 
    ...
    public function updated($fields)
    {
        $this->validateOnly($fields, [
           'promodiser_id' => 'required|unique:promodisers,promodiser_id,' .$this->promodiser_edit_id.'', 
            ...
            'promodiser_status'=> 'required|max:255',
    ...
    public function storePromodiserData() 
    {
        try {
            ...
            $promodiser->promodiser_status = $this->promodiser_status;
    ...
    public function editPromodiser($id)
    {
        ...
        $this->promodiser_status = $promodiser->promodiser_status;
    }    
    ...
    public function editPromodiserData()
    {
        try {
            $this->validate([  
                ...
                'Mobilenumber'=> ['required', 'numeric'],
                'promodiser_status'=> ['required', 'max:191']
            ]);
    ...
    public function closeViewPromodiserModal()
    {
      ...
      $this->view_promodiser_promodiser_status = '';
    ...
    public function render()
    {
        $promodisers = Promodisers::with('latest_assignment.location')
            ...
            ->orWhere('promodiser_status','like', '%' .$this->searchTerm.'%');
        ...
        $promodisers = $promodisers->paginate(5);
